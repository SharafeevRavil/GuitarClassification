...
class Ui_ViewTab(object):
    def setupUi(self, ViewTab):
        ...
        self.gridLayout.addWidget(self.label_author_name, 1, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.webEngineView, 2, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.label_tab_name, 0, 0, 1, 4)
        ...
        self.button_delete = QPushButton(ViewTab)
    ...
    def retranslateUi(self, ViewTab):
        ...
        self.button_delete.setText(QCoreApplication.translate("ViewTab", u"Delete", None))
    # retranslateUi
