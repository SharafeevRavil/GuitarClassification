...
class Ui_Profile(object):
    def setupUi(self, Profile):
        ...
        self.gridLayout.addWidget(self.label_image, 0, 0, 3, 1)
        ...
        self.gridLayout.addWidget(self.button_change_avatar, 3, 0, 1, 1)

        self.button_change_password = QPushButton(Profile)
        self.button_change_password.setObjectName(u"button_change_password")

        self.gridLayout.addWidget(self.button_change_password, 3, 1, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.field_login.sizePolicy().hasHeightForWidth())
        self.field_login.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.field_email.sizePolicy().hasHeightForWidth())
        self.field_email.setSizePolicy(sizePolicy)
